...
import lang_specific.LexiconReader;
import lang_specific.SuffixEntry;
import lang_specific.SuffixReader;
...
public class Analyzer {
    ...
    public Analyzer(int sortMode) {
        ...
        lexicon = lReader.read("_lang/TrLex");

        // reading the morphotactics
        FileReader fReader = new FileReader();
        ArrayList<String> tempList = fReader.read("_lang/Morphotactics");
        ...
        suffixList = sReader.read("_lang/SuffixList");
